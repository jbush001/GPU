...
class TestEmulator(unittest.TestCase):
    ...
    def test_and_vsv(self):
        self.run_test([make_r(0, 64 + 3, 1, 64 + 2)],
    ...
    def test_and_vvs(self):
        self.run_test([make_r(0, 64 + 3, 64 + 2, 1)],
                      init_regs={1: 0b10010101011001010100110010101001,
                       (64 + 2): [0xf, 0xf0, 0xf00, 0xf000, 0xf0000, 0xf00000, 0xf000000, 0xf0000000]},
                      final_regs={(64 + 3): [
                        0b1001,
    ...
    def test_and_vvv(self):
        self.run_test([make_r(0, 64 + 2, 64 + 3, 64 + 4)],
    ...
    def test_exec_mask_rrr(self):
        self.run_test([make_r(1, 64 + 3, 64 + 1, 64 + 1)],  # or v3, v1, v1
                      init_regs={32: 0x55,
    ...
    def test_recip(self):
        self.run_test([make_r(12, 2, 3, 0)],
                      init_regs={3: 0x3dfbe76d},  # 0.123
                      final_regs={2: 0x41021480})  # 8.125

    def test_f2i(self):
        self.run_test([make_r(13, 2, 3, 0)],
    ...
    def test_gtf(self):
        self.run_test([make_r(15, 2, 64 + 3, 4)],
    ...
    def test_ltf(self):
        self.run_test([make_r(16, 2, 64 + 3, 4)],
                      # -3.0, -2.0, -1.0, 0.0, 1.0, 2.0, 3.0, 4.0
                      init_regs={64 + 3: [0xc0400000, 0xc0000000, 0xbf800000, 0, 0x3f800000, 0x40000000, 0x40400000, 0x40800000],
                                 4: 0x3f800000}, # 1.0
    ...
    def test_bnz_taken(self):
        self.run_test([
                make_b(64, 2, 1), # This will jump over XOR, leaving reg intact
